...
function showLeaderboard() {
    ...
    modal.innerHTML = `
        <div class="leaderboard-content glass-panel">
            <h2>🌍 Global Top 10 Detectives</h2>
            <div id="leaderboard-list">Loading real-time rankings...</div>
            <button class="primary-btn" style="margin-top: 20px; width: 100%;" onclick="this.parentElement.parentElement.remove()">Close</button>
        </div>
    `;
    ...
    const unsubscribe = onSnapshot(q, (snapshot) => {
        ...
        snapshot.forEach((doc) => {
            ...
            row.innerHTML = `
                ...
                <img src="${data.photoURL || 'https://via.placeholder.com/32'}" class="lb-avatar">
